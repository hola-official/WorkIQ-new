...
contract TaskManagement is ReentrancyGuard, Ownable {
    ...
    constructor(address _XUSDTokenAddress) Ownable(msg.sender) {
        XUSDToken = IERC20(_XUSDTokenAddress);
    }
    ...
    function toggleSectionPublicationStatus(
        ...
        if (!section.isPublished) {
            require(user.XUSDBalance >= section.price, "Insufficient balance");
            user.XUSDBalance -= section.price;
    ...
    function claimSectionPayment(
        ...
        assignee.XUSDBalance += assigneePayment;
    ...
    function fundPlatform(
        ...
        XUSDToken.safeTransferFrom(msg.sender, address(this), amount);
        usersById[_userId].XUSDBalance += amount;
    ...
    function withdrawUserBalance(
        ...
        usersById[_userId].XUSDBalance -= amount;
        require(XUSDToken.transfer(msg.sender, amount), "Transfer failed");
    ...
    function getUserBalance(
        ...
        return usersById[_userId].XUSDBalance;
    }
    ...
    function getContractBalance() public view returns (uint256) {
        return XUSDToken.balanceOf(address(this));
    }
    ...
    function emergencyWithdraw() external onlyOwner {
        uint256 XUSDBalance = XUSDToken.balanceOf(address(this));
        require(XUSDBalance > 0, "No balance to withdraw");
        require(XUSDToken.transfer(owner(), XUSDBalance), "Transfer failed");
    }
    ...
    function cancelOrder(
        ...
        User storage client = usersById[getUserIdByAddress(task.client)];
        client.XUSDBalance += section.price;
        client.escrowBalance -= section.price;
    ...
    function checkAllowance(
        ...
        return XUSDToken.allowance(_user, address(this)) >= _amount;
    }
}
